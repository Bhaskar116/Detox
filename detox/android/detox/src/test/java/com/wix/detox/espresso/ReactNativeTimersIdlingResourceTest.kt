...
const val MEANINGFUL_TIMER_INTERVAL = BUSY_INTERVAL_MS - 1
...
fun aIdlingResourceCallback() = mock<ResourceCallback>()
...
class ReactNativeTimersIdlingResourceTest {
    ...
    @Test fun `should notify of transition to idle upon pausing`() {
        ...
        then(callback).should().onTransitionToIdle()
    }
